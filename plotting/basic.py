...
def plot_ana_spk(anasigs, spktrains):
    """Print spiketrains plus analog signals"""
...
def spk_trig_avg_detekt(anasigs, spktrains):
    """Detect any interesting spike-triggered average of analog signals.
...
def cross_corr(c, sr):
    ...
    :param type c: cross-correlation
    :param type sr: sampling rate
    :return: nothing
    :rtype: nothing
    """
    #make time values
